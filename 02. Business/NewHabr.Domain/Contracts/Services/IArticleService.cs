...
public interface IArticleService
{
    ...
    Task CreateAsync(CreateArticleRequest request, Guid creatorId, CancellationToken cancellationToken = default);

    /// <exception cref="ArticleNotFoundException"></exception>
    Task UpdateAsync(Guid articleId, Guid modifierId, UpdateArticleRequest articleToUpdate, CancellationToken cancellationToken = default);
